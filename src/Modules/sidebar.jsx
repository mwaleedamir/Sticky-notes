...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-50 dark:bg-gray-800 shadow-lg">
          ...
          <ul className="space-y-4">
            ...
            <li>
              ...
              >
                ...
                <span className="inline-flex items-center justify-center px-2 py-1 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
              </Link>
            </li>
            <li>
              <button
